export const COMMODITIES = [
  { key: 'gold', label: 'Золото', ticker: 'GC=F', short: 'GC', emoji: '🥇' },
  { key: 'silver', label: 'Серебро', ticker: 'SI=F', short: 'SI', emoji: '🥈' },
  { key: 'platinum', label: 'Платина', ticker: 'PL=F', short: 'PL', emoji: '⚪' },
  { key: 'palladium', label: 'Палладий', ticker: 'PA=F', short: 'PA', emoji: '⬜' },
  { key: 'crude-wti', label: 'Нефть WTI', ticker: 'CL=F', short: 'CL', emoji: '🛢️' },
  { key: 'crude-brent', label: 'Нефть Brent', ticker: 'BZ=F', short: 'BZ', emoji: '🛢️' },
  { key: 'natgas', label: 'Природный газ', ticker: 'NG=F', short: 'NG', emoji: '🔥' },
  { key: 'copper', label: 'Медь', ticker: 'HG=F', short: 'HG', emoji: '🟠' },
  { key: 'aluminum', label: 'Алюминий', ticker: 'ALI=F', short: 'ALI', emoji: '⚙️' },
  { key: 'wheat', label: 'Пшеница', ticker: 'ZW=F', short: 'ZW', emoji: '🌾' },
  { key: 'corn', label: 'Кукуруза', ticker: 'ZC=F', short: 'ZC', emoji: '🌽' },
  { key: 'soybeans', label: 'Соя', ticker: 'ZS=F', short: 'ZS', emoji: '🫘' },
  { key: 'coffee', label: 'Кофе', ticker: 'KC=F', short: 'KC', emoji: '☕' },
  { key: 'cocoa', label: 'Какао', ticker: 'CC=F', short: 'CC', emoji: '🍫' },
  { key: 'sugar', label: 'Сахар', ticker: 'SB=F', short: 'SB', emoji: '🍬' },
  { key: 'cotton', label: 'Хлопок', ticker: 'CT=F', short: 'CT', emoji: '🧵' },
];
